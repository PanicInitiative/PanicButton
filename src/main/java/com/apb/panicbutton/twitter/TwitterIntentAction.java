...
public enum TwitterIntentAction {
    VALID_SHORT_CODE("com.apb.panicbutton.twitter.TwitterIntentAction.VALID_SHORT_CODE", true),
    INVALID_SHORT_CODE("com.apb.panicbutton.twitter.TwitterIntentAction.INVALID_SHORT_CODE", false);
