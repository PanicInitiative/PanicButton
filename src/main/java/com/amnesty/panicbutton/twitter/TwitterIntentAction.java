...
public enum TwitterIntentAction {
    VALID_SHORT_CODE("com.amnesty.panicbutton.twitter.TwitterIntentAction.VALID_SHORT_CODE", true),
    INVALID_SHORT_CODE("com.amnesty.panicbutton.twitter.TwitterIntentAction.INVALID_SHORT_CODE", false);
